...
export const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Documentation, technical writing, and the deliverables around your build. I'm doing my own capstone — I know exactly where this gets painful.",
...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Two revisions are included with every request. [[TBD: confirm final revision count]] After that, revisions are billed at a small hourly rate — I'll quote it before starting.",
  },
  {
