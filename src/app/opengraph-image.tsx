...
const display = await readFile(join(process.cwd(), "assets/bricolage-800.ttf"));
const body = await readFile(join(process.cwd(), "assets/jakarta-400.ttf"));
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", fontFamily: "Jakarta", fontSize: 27, color: INK_SOFT }}>
            {serviceLine}
          </div>
        </div>
      </div>
    ),
    {
      ...
      fonts: [
        ...
        { name: "Jakarta", data: body, weight: 400, style: "normal" },
      ],
    }
  );
}
